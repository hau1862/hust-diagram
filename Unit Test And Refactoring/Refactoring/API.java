...
public class API {
	...
	/**
	 * quy định định dạng của kiểu ngày được dùng trong API
	 */
	public static DateFormat DATE_FORMATER = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	/**
	 * Log lại các thông tin console
	 */
	private static Logger LOGGER = Utils.getLogger(Utils.class.getName());

	/**
	 * 
	 * @param url:   đường dẫn cần request để lấy dữ liệu
	 * @param token: dùng token để xác thực
	 * @return response: phản hồi từ server sau khi được chuyển sang string
	 * @throws Exception
	 */
